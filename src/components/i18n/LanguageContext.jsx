...
const translations = {
    en: {
        ...
        acquirersAndBanks: 'Acquirers & Banks',
        alternativePayments: 'Alternative Payment Methods',
        cryptoExchanges: 'Crypto Exchanges',
        blockchainNodes: 'Blockchain Nodes',

        aiSmartRouting: 'AI Smart Routing',
        routingRules: 'Routing Rules',
        midRouting: 'MID Routing',
        bankMIDs: 'Bank MIDs',

        physicalTerminals: 'Physical Terminals',
