            ...
            fr: { 
                ...
                pages: {
                  ...
                  pspProvisioning: {
                    ...
                    noMatches: "Aucun PSP ne correspond à votre recherche",
                    provisionFirst: "Provisionnez votre premier PSP",
                    ...
                    acrossAllPSPs: "Dans tous les PSP",
                    monthlyVolume: "Volume mensuel",
                    vsLastMonth: "vs mois dernier",
                    monthlyRevenue: "Revenus mensuels",
                    ftsEarnings: "Gains FTS.Money",
                    merchants: "Marchands",
                    volume: "Volume",
                    manage: "Gérer",
            ...
            es: { 
                ...
                pages: {
                  ...
                  pspProvisioning: {
                    ...
                    noMatches: "Ningún PSP coincide con su búsqueda",
                    provisionFirst: "Aprovisione su primer PSP",
                    isoCompliant: "Conforme ISO",
                    complianceIssue: "Problema de cumplimiento",
                    loggedInAs: "Conectado como",
                    totalPSPs: "Total PSPs",
                    active: "activo",
                    totalMerchants: "Total comerciantes",
                    acrossAllPSPs: "En todos los PSP",
                    monthlyVolume: "Volumen mensual",
                    vsLastMonth: "vs mes pasado",
                    monthlyRevenue: "Ingresos mensuales",
                    ftsEarnings: "Ganancias FTS.Money",
            ...
            de: { 
                ...
                pages: {
                  ...
                  pspProvisioning: {
                    ...
                    noMatches: "Keine PSPs entsprechen Ihrer Suche",
                    provisionFirst: "Stellen Sie Ihren ersten PSP bereit",
                    isoCompliant: "ISO-konform",
                    complianceIssue: "Compliance-Problem",
                    loggedInAs: "Angemeldet als",
                    totalPSPs: "PSPs gesamt",
                    active: "aktiv",
                    totalMerchants: "Händler gesamt",
                    acrossAllPSPs: "Über alle PSPs",
                    monthlyVolume: "Monatliches Volumen",
                    vsLastMonth: "vs letzter Monat",
                    monthlyRevenue: "Monatlicher Umsatz",
                    ftsEarnings: "FTS.Money Einnahmen",
                    merchants: "Händler",
                    volume: "Volumen",
                    manage: "Verwalten",
