...
import { Trophy, Menu, X, CheckCircle2, XCircle, Clock, ShoppingBag, AlertCircle } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50/20 to-blue-50/30">
            <aside className={cn("fixed md:static inset-y-0 left-0 z-50 w-64 bg-white border-r flex flex-col h-screen transform transition-transform",
                ...
                <nav className="flex-1 p-4 space-y-2">
                    ...
                    <a href="/LoyaltyRedemptionApprovals" className="block px-3 py-2 rounded-lg bg-purple-50 text-purple-700 font-medium">
                        <AlertCircle className="h-4 w-4 inline mr-2" />Redemption Approvals
                    </a>
                </nav>
            </aside>
