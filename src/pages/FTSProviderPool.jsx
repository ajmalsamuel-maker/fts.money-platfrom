...
export default function FTSProviderPool() {
    ...
    return (
        <div className="flex h-screen bg-slate-50">
            <FTSPlatformSidebar currentPage="FTSProviderPool" userRole="Platform Operator" />
            
            <div className="flex-1 overflow-auto">
                <div className="bg-white border-b border-slate-200 px-6 py-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-2xl font-bold text-slate-900">Payment Provider Pool</h1>
                            <p className="text-sm text-slate-600">Global provider registry available for PSP assignment</p>
                        </div>
