...
export default function OrchestrationDocumentation() {
    const { platformUser, loading } = usePlatformAuth();

    const downloadMarkdown = () => {
        const element = document.createElement('a');
        const file = new Blob([OrchestrationDoc], { type: 'text/markdown' });
        element.href = URL.createObjectURL(file);
        element.download = 'orchestration-documentation.md';
    ...
    const downloadPDF = () => {
        ...
        const lines = OrchestrationDoc.split('\n');
        let yPosition = margin;

        // Title page
        pdf.setFontSize(24);
        pdf.text('Payment Orchestration Service', pageWidth / 2, 40, { align: 'center' });
        pdf.setFontSize(12);
        ...
        pdf.save('orchestration-documentation.pdf');
    };
    ...
    return (
        <div className="flex h-screen bg-slate-50">
            <FTSPlatformSidebarRestructured 
                currentPage="OrchestrationDocumentation"
            ...
            <div className="flex-1 overflow-auto">
                <div className="p-6">
                    <div className="mb-6">
                        <h1 className="text-3xl font-bold text-slate-900 mb-2">Orchestration Documentation</h1>
                        <p className="text-slate-600">Intelligent payment routing and optimization</p>
                    </div>
                    ...
                    <Card>
                        <CardHeader className="border-b bg-white">
                            <div className="flex items-start justify-between">
                                <div>
                                    <CardTitle className="text-2xl">Payment Orchestration Service</CardTitle>
                                    <p className="text-sm text-slate-600 mt-1">Smart routing, failover, and cost optimization for payment processing</p>
                                </div>
