...
export default function FTSArchitectureDoc() {
    ...
    const downloadMarkdown = () => {
        ...
        const file = new Blob([ArchitectureDoc], { type: 'text/markdown' });
        element.href = URL.createObjectURL(file);
        element.download = 'fts-money-architecture.md';
    ...
    return (
        <div className="flex h-screen bg-slate-50">
            <FTSPlatformSidebar 
                currentPage="FTSArchitectureDoc"
                        ...
                        <CardHeader className="border-b bg-white">
                            <div className="flex items-start justify-between">
                                <div>
                                    ...
                                    <p className="text-sm text-slate-600 mt-1">Technical infrastructure, system design, and security architecture</p>
                                </div>
                                <Button
