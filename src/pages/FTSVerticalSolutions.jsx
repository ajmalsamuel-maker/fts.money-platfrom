...
export default function FTSVerticalSolutions() {
    ...
    const downloadMarkdown = () => {
        ...
        const file = new Blob([VerticalSolutionsDoc], { type: 'text/markdown' });
        element.href = URL.createObjectURL(file);
        element.download = 'fts-money-vertical-solutions.md';
                    ...
                    <Card>
                        <CardHeader className="border-b bg-white">
                            <div className="flex items-start justify-between">
                                <div>
                                    <CardTitle className="text-2xl">Vertical Solutions</CardTitle>
                                    <p className="text-sm text-slate-600 mt-1">Industry-specific payment solutions and implementations</p>
                                </div>
                                <Button
