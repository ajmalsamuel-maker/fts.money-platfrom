...
export default function CryptoGatewayUserManagement() {
    ...
    const inviteMutation = useMutation({
        mutationFn: async (userData) => {
            const response = await base44.functions.invoke('cryptoGatewayUserManagement', { action: 'invite', ...userData });
            ...
            <div className="flex-1 overflow-auto">
                <header className="h-16 bg-white border-b flex items-center justify-between px-6">
                    <div>
                        ...
                        <p className="text-xs text-slate-600">Manage users across crypto banking customers</p>
                    </div>
                    <Dialog open={inviteOpen} onOpenChange={setInviteOpen}>
                        ...
                        <DialogContent>
                            <DialogHeader><DialogTitle>Invite Crypto Banking User</DialogTitle></DialogHeader>
                ...
                <div className="p-6">
                    <Card>
                        <CardHeader><CardTitle className="flex items-center gap-2"><Wallet className="h-5 w-5" />Crypto Banking Users ({users.length})</CardTitle></CardHeader>
                        <CardContent>
