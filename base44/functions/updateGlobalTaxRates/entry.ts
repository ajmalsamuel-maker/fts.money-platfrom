...
async function getAllCountryRules() {
    // Comprehensive tax rules for 157 countries
    const TAX_RULES = {
        // Europe
        ...
        'BE': { name: 'Belgium', type: 'VAT', standard: 21, reduced: [6, 12], digital_services: 21, physical_goods: 21, reverse_charge_b2b: true, exemptions: ['financial', 'insurance', 'health', 'education'] },
        'BG': { name: 'Bulgaria', type: 'VAT', standard: 20, reduced: [9], digital_services: 20, physical_goods: 20, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'HR': { name: 'Croatia', type: 'VAT', standard: 25, reduced: [5, 13], digital_services: 25, physical_goods: 25, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'CY': { name: 'Cyprus', type: 'VAT', standard: 19, reduced: [5, 9], digital_services: 19, physical_goods: 19, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'CZ': { name: 'Czech Republic', type: 'VAT', standard: 21, reduced: [10, 15], digital_services: 21, physical_goods: 21, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'DK': { name: 'Denmark', type: 'VAT', standard: 25, reduced: [], digital_services: 25, physical_goods: 25, reverse_charge_b2b: true, exemptions: ['financial', 'insurance', 'health', 'education'] },
        'EE': { name: 'Estonia', type: 'VAT', standard: 22, reduced: [9], digital_services: 22, physical_goods: 22, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'FI': { name: 'Finland', type: 'VAT', standard: 25.5, reduced: [10, 14], digital_services: 25.5, physical_goods: 25.5, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'FR': { name: 'France', type: 'VAT', standard: 20, reduced: [5.5, 10], digital_services: 20, physical_goods: 20, reverse_charge_b2b: true, exemptions: ['financial', 'insurance', 'health', 'education'] },
        'DE': { name: 'Germany', type: 'VAT', standard: 19, reduced: [7], digital_services: 19, physical_goods: 19, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'GR': { name: 'Greece', type: 'VAT', standard: 24, reduced: [6, 13], digital_services: 24, physical_goods: 24, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'HU': { name: 'Hungary', type: 'VAT', standard: 27, reduced: [5, 18], digital_services: 27, physical_goods: 27, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'IE': { name: 'Ireland', type: 'VAT', standard: 23, reduced: [9, 13.5], digital_services: 23, physical_goods: 23, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'IT': { name: 'Italy', type: 'VAT', standard: 22, reduced: [4, 5, 10], digital_services: 22, physical_goods: 22, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'LV': { name: 'Latvia', type: 'VAT', standard: 21, reduced: [5, 12], digital_services: 21, physical_goods: 21, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'LT': { name: 'Lithuania', type: 'VAT', standard: 21, reduced: [5, 9], digital_services: 21, physical_goods: 21, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'LU': { name: 'Luxembourg', type: 'VAT', standard: 17, reduced: [3, 8, 14], digital_services: 17, physical_goods: 17, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'MT': { name: 'Malta', type: 'VAT', standard: 18, reduced: [5, 7], digital_services: 18, physical_goods: 18, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'NL': { name: 'Netherlands', type: 'VAT', standard: 21, reduced: [9], digital_services: 21, physical_goods: 21, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'PL': { name: 'Poland', type: 'VAT', standard: 23, reduced: [5, 8], digital_services: 23, physical_goods: 23, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'PT': { name: 'Portugal', type: 'VAT', standard: 23, reduced: [6, 13], digital_services: 23, physical_goods: 23, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'RO': { name: 'Romania', type: 'VAT', standard: 19, reduced: [5, 9], digital_services: 19, physical_goods: 19, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'SK': { name: 'Slovakia', type: 'VAT', standard: 20, reduced: [10], digital_services: 20, physical_goods: 20, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'SI': { name: 'Slovenia', type: 'VAT', standard: 22, reduced: [5, 9.5], digital_services: 22, physical_goods: 22, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'ES': { name: 'Spain', type: 'VAT', standard: 21, reduced: [4, 10], digital_services: 21, physical_goods: 21, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'SE': { name: 'Sweden', type: 'VAT', standard: 25, reduced: [6, 12], digital_services: 25, physical_goods: 25, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'GB': { name: 'United Kingdom', type: 'VAT', standard: 20, reduced: [5], digital_services: 20, physical_goods: 20, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'NO': { name: 'Norway', type: 'VAT', standard: 25, reduced: [12, 15], digital_services: 25, physical_goods: 25, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'CH': { name: 'Switzerland', type: 'VAT', standard: 8.1, reduced: [2.6, 3.8], digital_services: 8.1, physical_goods: 8.1, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'IS': { name: 'Iceland', type: 'VAT', standard: 24, reduced: [11], digital_services: 24, physical_goods: 24, reverse_charge_b2b: true, exemptions: ['financial', 'insurance'] },
        'TR': { name: 'Turkey', type: 'KDV', standard: 20, reduced: [1, 10], digital_services: 20, physical_goods: 20, reverse_charge_b2b: false, exemptions: ['financial', 'insurance'] },
        'RS': { name: 'Serbia', type: 'VAT', standard: 20, reduced: [10], digital_services: 20, physical_goods: 20, reverse_charge_b2b: false, exemptions: ['financial', 'insurance'] },
        'UA': { name: 'Ukraine', type: 'VAT', standard: 20, reduced: [7], digital_services: 20, physical_goods: 20, reverse_charge_b2b: false, exemptions: ['financial', 'insurance'] },
        ...
        'BH': { name: 'Bahrain', type: 'VAT', standard: 10, reduced: [], zero: ['exports', 'health', 'education'], digital_services: 10, physical_goods: 10, exemptions: ['financial', 'residential_property'] },
        'OM': { name: 'Oman', type: 'VAT', standard: 5, reduced: [], zero: ['exports', 'health', 'education'], digital_services: 5, physical_goods: 5, exemptions: ['financial'] },
        'QA': { name: 'Qatar', type: 'No VAT', standard: 0, reduced: [], digital_services: 0, physical_goods: 0, exemptions: [] },
        'KW': { name: 'Kuwait', type: 'No VAT', standard: 0, reduced: [], digital_services: 0, physical_goods: 0, exemptions: [] },
        'IL': { name: 'Israel', type: 'VAT', standard: 17, reduced: [], zero: ['exports'], digital_services: 17, physical_goods: 17, exemptions: ['financial', 'insurance'] },
        'EG': { name: 'Egypt', type: 'VAT', standard: 14, reduced: [5], digital_services: 14, physical_goods: 14, exemptions: ['financial', 'insurance', 'basic_foods'] },
        'ZA': { name: 'South Africa', type: 'VAT', standard: 15, reduced: [], zero: ['exports', 'basic_foods'], digital_services: 15, physical_goods: 15, exemptions: ['financial', 'insurance'] },
        'NG': { name: 'Nigeria', type: 'VAT', standard: 7.5, reduced: [], zero: ['exports'], digital_services: 7.5, physical_goods: 7.5, exemptions: ['financial', 'insurance'] },
        'KE': { name: 'Kenya', type: 'VAT', standard: 16, reduced: [], zero: ['exports', 'basic_foods'], digital_services: 16, physical_goods: 16, exemptions: ['financial', 'insurance'] },
        'GH': { name: 'Ghana', type: 'VAT', standard: 15, reduced: [], zero: ['exports'], digital_services: 15, physical_goods: 15, exemptions: ['financial', 'insurance'] },
        'TZ': { name: 'Tanzania', type: 'VAT', standard: 18, reduced: [], zero: ['exports'], digital_services: 18, physical_goods: 18, exemptions: ['financial', 'insurance'] },
        'UG': { name: 'Uganda', type: 'VAT', standard: 18, reduced: [], zero: ['exports'], digital_services: 18, physical_goods: 18, exemptions: ['financial', 'insurance'] },
        'ET': { name: 'Ethiopia', type: 'VAT', standard: 15, reduced: [], zero: ['exports'], digital_services: 15, physical_goods: 15, exemptions: ['financial', 'insurance'] },
        'MA': { name: 'Morocco', type: 'VAT', standard: 20, reduced: [7, 10, 14], zero: ['exports'], digital_services: 20, physical_goods: 20, exemptions: ['financial', 'insurance'] },
        'TN': { name: 'Tunisia', type: 'VAT', standard: 19, reduced: [7, 13], zero: ['exports'], digital_services: 19, physical_goods: 19, exemptions: ['financial', 'insurance'] },

        // Asia Pacific
        'AU': { name: 'Australia', type: 'GST', standard: 10, reduced: [], zero: ['exports', 'health', 'education'], digital_services: 10, physical_goods: 10, exemptions: ['financial', 'residential_property'] },
        'NZ': { name: 'New Zealand', type: 'GST', standard: 15, reduced: [], zero: ['exports'], digital_services: 15, physical_goods: 15, exemptions: ['financial', 'residential_property'] },
        ...
        'MY': { name: 'Malaysia', type: 'SST', standard: 8, reduced: [], zero: ['exports'], digital_services: 8, physical_goods: 8, exemptions: ['financial', 'insurance'] },
        'IN': { name: 'India', type: 'GST', standard: 18, reduced: [5, 12, 28], zero: ['exports', 'basic_foods'], digital_services: 18, physical_goods: 18, exemptions: ['financial', 'insurance', 'health', 'education'] },
        'PK': { name: 'Pakistan', type: 'Sales Tax', standard: 17, reduced: [10], zero: ['exports'], digital_services: 17, physical_goods: 17, exemptions: ['financial'] },
        'BD': { name: 'Bangladesh', type: 'VAT', standard: 15, reduced: [7.5], zero: ['exports'], digital_services: 15, physical_goods: 15, exemptions: ['financial', 'insurance'] },
        'LK': { name: 'Sri Lanka', type: 'VAT', standard: 15, reduced: [8], zero: ['exports'], digital_services: 15, physical_goods: 15, exemptions: ['financial', 'insurance'] },
        'TH': { name: 'Thailand', type: 'VAT', standard: 7, reduced: [], zero: ['exports'], digital_services: 7, physical_goods: 7, exemptions: ['financial', 'insurance'] },
        'VN': { name: 'Vietnam', type: 'VAT', standard: 10, reduced: [5], zero: ['exports'], digital_services: 10, physical_goods: 10, exemptions: ['financial', 'insurance'] },
        'ID': { name: 'Indonesia', type: 'VAT', standard: 11, reduced: [], zero: ['exports'], digital_services: 11, physical_goods: 11, exemptions: ['financial', 'insurance'] },
        'PH': { name: 'Philippines', type: 'VAT', standard: 12, reduced: [], zero: ['exports'], digital_services: 12, physical_goods: 12, exemptions: ['financial', 'insurance'] },
        'JP': { name: 'Japan', type: 'Consumption Tax', standard: 10, reduced: [8], zero: ['exports'], digital_services: 10, physical_goods: 10, exemptions: ['financial', 'insurance'] },
        'KR': { name: 'South Korea', type: 'VAT', standard: 10, reduced: [], zero: ['exports'], digital_services: 10, physical_goods: 10, exemptions: ['financial', 'insurance'] },
        'CN': { name: 'China', type: 'VAT', standard: 13, reduced: [6, 9], zero: ['exports'], digital_services: 6, physical_goods: 13, exemptions: ['financial', 'insurance'] },
        'TW': { name: 'Taiwan', type: 'VAT', standard: 5, reduced: [], zero: ['exports'], digital_services: 5, physical_goods: 5, exemptions: ['financial', 'insurance'] },
        'HK': { name: 'Hong Kong', type: 'No VAT/GST', standard: 0, reduced: [], digital_services: 0, physical_goods: 0, exemptions: [] },
        'MO': { name: 'Macau', type: 'No VAT/GST', standard: 0, reduced: [], digital_services: 0, physical_goods: 0, exemptions: [] },

        // Americas
        'US': { name: 'United States', type: 'State Sales Tax', standard: 0, reduced: [], digital_services: 0, physical_goods: 0, exemptions: [], notes: 'State-level taxation varies 0-10%' },
        'CA': { name: 'Canada', type: 'GST+Provincial', standard: 5, reduced: [], zero: ['exports', 'basic_foods'], digital_services: 5, physical_goods: 5, exemptions: ['financial', 'insurance'], notes: 'Plus provincial taxes 0-10%' },
        'MX': { name: 'Mexico', type: 'IVA', standard: 16, reduced: [], zero: ['exports'], digital_services: 16, physical_goods: 16, exemptions: ['financial', 'insurance'] },
        'BR': { name: 'Brazil', type: 'ICMS', standard: 17, reduced: [], zero: ['exports'], digital_services: 17, physical_goods: 17, exemptions: ['financial'], notes: 'State-level ICMS varies' },
        'AR': { name: 'Argentina', type: 'IVA', standard: 21, reduced: [10.5], zero: ['exports'], digital_services: 21, physical_goods: 21, exemptions: ['financial', 'insurance'] },
        'CL': { name: 'Chile', type: 'IVA', standard: 19, reduced: [], zero: ['exports'], digital_services: 19, physical_goods: 19, exemptions: ['financial', 'insurance'] },
        'CO': { name: 'Colombia', type: 'IVA', standard: 19, reduced: [5], zero: ['exports'], digital_services: 19, physical_goods: 19, exemptions: ['financial', 'insurance'] },
        'PE': { name: 'Peru', type: 'IGV', standard: 18, reduced: [], zero: ['exports'], digital_services: 18, physical_goods: 18, exemptions: ['financial', 'insurance'] },
        'EC': { name: 'Ecuador', type: 'IVA', standard: 15, reduced: [], zero: ['exports'], digital_services: 15, physical_goods: 15, exemptions: ['financial', 'insurance'] },
        'VE': { name: 'Venezuela', type: 'IVA', standard: 16, reduced: [8], zero: ['exports'], digital_services: 16, physical_goods: 16, exemptions: ['financial', 'insurance'] },
        'UY': { name: 'Uruguay', type: 'IVA', standard: 22, reduced: [10], zero: ['exports'], digital_services: 22, physical_goods: 22, exemptions: ['financial', 'insurance'] },
        'PY': { name: 'Paraguay', type: 'IVA', standard: 10, reduced: [5], zero: ['exports'], digital_services: 10, physical_goods: 10, exemptions: ['financial', 'insurance'] },
        'BO': { name: 'Bolivia', type: 'IVA', standard: 13, reduced: [], zero: ['exports'], digital_services: 13, physical_goods: 13, exemptions: ['financial', 'insurance'] },
        'CR': { name: 'Costa Rica', type: 'IVA', standard: 13, reduced: [2, 4], zero: ['exports'], digital_services: 13, physical_goods: 13, exemptions: ['financial', 'insurance'] },
        'PA': { name: 'Panama', type: 'ITBMS', standard: 7, reduced: [], zero: ['exports'], digital_services: 7, physical_goods: 7, exemptions: ['financial', 'insurance'] },
        'GT': { name: 'Guatemala', type: 'IVA', standard: 12, reduced: [], zero: ['exports'], digital_services: 12, physical_goods: 12, exemptions: ['financial', 'insurance'] },
        'SV': { name: 'El Salvador', type: 'IVA', standard: 13, reduced: [], zero: ['exports'], digital_services: 13, physical_goods: 13, exemptions: ['financial', 'insurance'] },
        'HN': { name: 'Honduras', type: 'ISV', standard: 15, reduced: [], zero: ['exports'], digital_services: 15, physical_goods: 15, exemptions: ['financial', 'insurance'] },
        'NI': { name: 'Nicaragua', type: 'IVA', standard: 15, reduced: [], zero: ['exports'], digital_services: 15, physical_goods: 15, exemptions: ['financial', 'insurance'] },
        'DO': { name: 'Dominican Republic', type: 'ITBIS', standard: 18, reduced: [16], zero: ['exports'], digital_services: 18, physical_goods: 18, exemptions: ['financial', 'insurance'] },
        'JM': { name: 'Jamaica', type: 'GCT', standard: 15, reduced: [], zero: ['exports'], digital_services: 15, physical_goods: 15, exemptions: ['financial', 'insurance'] },
        'TT': { name: 'Trinidad and Tobago', type: 'VAT', standard: 12.5, reduced: [], zero: ['exports'], digital_services: 12.5, physical_goods: 12.5, exemptions: ['financial', 'insurance'] },
        'BB': { name: 'Barbados', type: 'VAT', standard: 17.5, reduced: [7.5], zero: ['exports'], digital_services: 17.5, physical_goods: 17.5, exemptions: ['financial', 'insurance'] },

        // Other regions
        'RU': { name: 'Russia', type: 'VAT', standard: 20, reduced: [10], zero: ['exports'], digital_services: 20, physical_goods: 20, exemptions: ['financial', 'insurance'] },
        'KZ': { name: 'Kazakhstan', type: 'VAT', standard: 12, reduced: [], zero: ['exports'], digital_services: 12, physical_goods: 12, exemptions: ['financial', 'insurance'] },
        'UZ': { name: 'Uzbekistan', type: 'VAT', standard: 12, reduced: [], zero: ['exports'], digital_services: 12, physical_goods: 12, exemptions: ['financial', 'insurance'] },
        'BY': { name: 'Belarus', type: 'VAT', standard: 20, reduced: [10], zero: ['exports'], digital_services: 20, physical_goods: 20, exemptions: ['financial', 'insurance'] },
        'AM': { name: 'Armenia', type: 'VAT', standard: 20, reduced: [], zero: ['exports'], digital_services: 20, physical_goods: 20, exemptions: ['financial', 'insurance'] },
        'GE': { name: 'Georgia', type: 'VAT', standard: 18, reduced: [], zero: ['exports'], digital_services: 18, physical_goods: 18, exemptions: ['financial', 'insurance'] },
        'AZ': { name: 'Azerbaijan', type: 'VAT', standard: 18, reduced: [], zero: ['exports'], digital_services: 18, physical_goods: 18, exemptions: ['financial', 'insurance'] }
    };
